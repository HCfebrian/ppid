...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          ...
          path: '/layananPelatihanListPage',
          builder: (context, params) => const LayananPelatihanListPageWidget(),
        ),
        FFRoute(
          name: 'KalenderPage',
          path: '/kalenderPage',
          builder: (context, params) => const KalenderPageWidget(),
        ),
        FFRoute(
          name: 'TentangKamiPage',
          path: '/tentangKamiPage',
          builder: (context, params) => const TentangKamiPageWidget(),
        ),
        FFRoute(
          name: 'HubungiKamiPage',
          path: '/hubungiKamiPage',
          builder: (context, params) => const HubungiKamiPageWidget(),
        ),
        FFRoute(
